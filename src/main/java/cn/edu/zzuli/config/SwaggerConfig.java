...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select() //为controller包路径
                .apis(RequestHandlerSelectors.basePackage("cn.edu.zzuli")).paths(PathSelectors.any()).build();
    } //构建 api文档的详细信息函数
